  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[#f5f7f2] text-[var(--ink)]">
      <div className="mx-auto max-w-7xl px-5 sm:px-8">
        ...
        <section className="grid gap-8 border-t border-[var(--line)] py-20 lg:grid-cols-[0.8fr_1.2fr]"><div><p className="text-xs font-bold uppercase tracking-[0.2em] text-[var(--mint-dark)]">Untuk penggunaan sehari-hari</p><h2 className="mt-3 text-3xl font-bold sm:text-4xl">Buku kas yang mengikuti ritme Anda.</h2></div><div className="grid gap-4 sm:grid-cols-2"><div className="rounded-2xl bg-[var(--ink)] p-5 text-white"><p className="text-sm font-bold text-[#b9dcca]">Freelancer</p><p className="mt-3 text-lg font-semibold">Pisahkan pemasukan proyek dan biaya kerja dengan cepat.</p></div><div className="rounded-2xl border border-[var(--line)] bg-white p-5"><p className="text-sm font-bold text-[var(--mint-dark)]">Personal finance</p><p className="mt-3 text-lg font-semibold">Temukan kategori pengeluaran yang paling banyak mengambil saldo.</p></div></div></section>
